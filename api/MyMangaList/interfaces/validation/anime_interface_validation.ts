...
import AnimeList, { AnimeDetail, AnimeListItem, AnimeRankingItem, AnimeRankingList } from "../anime_interface";
import  { zod_schema_anime_picture, zod_enum_anime_media, zod_enum_anime_source, zod_enum_nfsw, zod_enum_rating, zod_enum_status, zod_schema_anime_alternative_title, zod_schema_anime_broadcast, zod_schema_anime_genre, zod_schema_anime_paging, zod_schema_anime_start_season, zod_schema_related_anime, zod_schema_anime_recommendations, zod_schema_anime_statistics } from "./util_validation";
